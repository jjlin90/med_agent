...
DOMAIN_INTENT_MIN_CONFIDENCE = min(
    1.0, max(0.0, float(os.getenv("DOMAIN_INTENT_MIN_CONFIDENCE", "0.65")))
)
SAFETY_INTENT_MIN_CONFIDENCE = min(
    1.0, max(0.0, float(os.getenv("SAFETY_INTENT_MIN_CONFIDENCE", "0.75")))
)
